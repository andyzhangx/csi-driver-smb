...
| `windows.requirePrivacyForGlobalMapping`                | require SMB encryption (`-RequirePrivacy`) on `New-SmbGlobalMapping`; only applies when `useHostProcessContainers` is true | `true`                                                  |
